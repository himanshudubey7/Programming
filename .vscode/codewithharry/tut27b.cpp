//FRIEND CLASS: IF YOU WANT TO DECLARE SUPOSE SOME 100 FUNCTIONS FRIENDLY FOR SOME OTHER CLASS THEN WISER 
                     // WAY WOULD BE THAT YOU DECLARE COMPLETE CLASS A FRIEND CLASS
...
// defining  the calculator class functions 
